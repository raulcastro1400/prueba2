            ...
            <div class="container">
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        ...
                        <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+051 945 516 844</p>
                        <p class="mb-2"><i class="fa fa-envelope me-3"></i>info@cetprojct.edu.pe</p>
                    </div>
                    <div class="col-lg-3 col-md-6">
                    ...
                    <div class="col-lg-3 col-md-2">
                        ...
                        <div class="d-flex pt-2">
                            <a class="btn btn-square btn-outline-light me-1" href="https://www.gmail.com"><i class="fab fa-google"></i></a>
                            <a class="btn btn-square btn-outline-light me-1" href="https://www.facebook.com/CetproJulioCtello"><i class="fab fa-facebook-f"></i></a>
                            <a class="btn btn-square btn-outline-light me-1" href="https://www.youtube.com/CetproJulioCtello"><i class="fab fa-youtube"></i></a>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        Copyright  &copy; <a href="#">Cetpro Julio C. Tello</a> 2023.
                    </div>
                    <div class="col-md-6 text-center text-md-end">
                        Diseñador por <a href="">RAUL CASTRO</a>
